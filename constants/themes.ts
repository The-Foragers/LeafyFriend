...
export const CustomPaperDarkTheme: MD3Theme = {
  ...
  colors: {
    ...
    primary: SelectedPalette['200'],
    onPrimary: SelectedPalette['900'],
    secondary: SelectedPalette['300'],
    onSecondary: SelectedPalette['900'],
    background: '#121212',
    onBackground: SelectedPalette['50'],
    surface: SelectedPalette['800'],
    onSurface: SelectedPalette['50'],
    error: '#CF6679',
    onError: '#000000',
    outline: SelectedPalette['600'],
    surfaceVariant: SelectedPalette['700'],
    onSurfaceVariant: SelectedPalette['200'],
    inverseSurface: SelectedPalette['100'],
    inverseOnSurface: SelectedPalette['900'],
    primaryContainer: SelectedPalette['500'],
    onPrimaryContainer: SelectedPalette['50'],
    secondaryContainer: SelectedPalette['600'],
    onSecondaryContainer: SelectedPalette['50'],
    tertiary: SelectedPalette['700'],
    onTertiary: SelectedPalette['50'],
  },
};
...
export const CustomNavigationDarkTheme: NavigationTheme = {
  ...
  colors: {
    ...
    primary: SelectedPalette['200'],
    background: '#121212',
    card: SelectedPalette['800'],
    text: SelectedPalette['50'],
    border: SelectedPalette['600'],
    notification: SelectedPalette['300'],
  },
};